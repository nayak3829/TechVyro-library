...
export function WhatsAppPopup() {
  ...
  useEffect(() => {
    ...
    try {
      alreadyShown = sessionStorage.getItem('wa_popup_shown');
    } catch {}
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative w-full max-w-[calc(100vw-2rem)] sm:max-w-sm"
        style={{
          opacity: isVisible ? 1 : 0,
      ...
      >
        {/* Glow */}
        <div
          className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-[#25D366] via-emerald-400 to-[#128C7E] blur-xl"
          style={{
        ...
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 border border-white/10 shadow-2xl">
          ...
          <div className="relative px-4 sm:px-6 pt-6 sm:pt-8 pb-5 sm:pb-6">
            ...
            <h2 id="whatsapp-popup-title" className="text-center text-xl sm:text-2xl font-bold mb-1.5">
            ...
            <p className="text-gray-400 text-center mb-4 text-xs sm:text-sm leading-relaxed">
