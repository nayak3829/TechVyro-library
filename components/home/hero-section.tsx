          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center md:justify-start gap-3 w-full sm:w-auto mb-7 sm:mb-9">
              ...
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 px-7 sm:px-8 h-12 sm:h-13 rounded-xl border border-border/70 bg-card/80 backdrop-blur-sm text-foreground text-sm font-semibold hover:border-[#25D366]/50 hover:bg-[#25D366]/5 transition-all duration-200"
              >
