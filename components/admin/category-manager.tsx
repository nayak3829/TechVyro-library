...
const COLOR_NAMES = ["Blue", "Green", "Purple", "Pink", "Amber", "Red", "Cyan", "Indigo"]
                ...
                <div className="flex items-center gap-1.5 flex-wrap">
                  {PRESET_COLORS.map((presetColor) => (
                    <button
                      key={presetColor}
                      type="button"
                      aria-label={`Select ${COLOR_NAMES[PRESET_COLORS.indexOf(presetColor)]} color`}
          ...
          {categories.length === 0 ? (
            ...
            <div className="space-y-2">
              {categories.map((category) => (
                <div
                  key={category.id}
                  className="flex flex-wrap items-center gap-3 p-3 rounded-lg border border-border/50 bg-card hover:bg-muted/30 transition-colors sm:flex-nowrap"
                >
                    ...
                    <>
                      <div className="flex items-center gap-1.5 flex-wrap">
                        {PRESET_COLORS.map((presetColor) => (
                            ...
                            type="button"
                              aria-label={`Select ${COLOR_NAMES[PRESET_COLORS.indexOf(presetColor)]} color`}
                              aria-pressed={editColor === presetColor}
