    ...
    <footer className="relative border-t border-border/40 bg-gradient-to-b from-background to-muted/30">
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          {/* Brand */}
          <div className="sm:col-span-2 lg:col-span-1 min-w-0 space-y-5">
            <Link href="/" className="inline-flex items-center gap-3 group">
              <img
                ...
                width={44}
                height={44}
                className="h-11 w-11 rounded-xl object-contain shadow-lg shadow-primary/20 transition-transform group-hover:scale-105"
              />
              <div className="min-w-0">
                ...
                <p className="break-words text-[10px] text-muted-foreground">{s.siteTagline}</p>
              </div>
            </Link>
                ...
                <li key={link.name}>
                  {link.external ? (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                    className="inline-flex max-w-full items-center gap-2 py-1.5 break-words hover:text-primary hover:translate-x-1 transition-all duration-200"
                    >
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li>
                <a 
                  ...
                  className="flex min-w-0 items-center gap-3 hover:text-primary transition-colors group"
                >
                  ...
                  <span className="min-w-0 break-all">{s.contactEmail}</span>
                </a>
              </li>
              <li>
                <a 
                ...
                >
                  ...
                  <span className="min-w-0 break-all">{s.mainWebsite.replace(/^https?:\/\//, "").replace(/\/$/, "")}</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="min-w-0 space-y-5">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-[#087a3e] text-white text-sm font-medium hover:bg-[#066333] shadow-lg shadow-[#25D366]/20 hover:shadow-xl hover:shadow-[#25D366]/30 hover:-translate-y-0.5 transition-all duration-300"
            >
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
          <p className="min-w-0 break-words flex flex-wrap items-center justify-center gap-1 sm:gap-2 text-center">
