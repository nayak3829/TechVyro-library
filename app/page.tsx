      ...
      <main>
        ...
        <section id="content" className="py-16 sm:py-20 lg:py-24 bg-background">
          <div className="container mx-auto px-4">
            ...
            {/* Setup Notice */}
            {!configured && (
              <div className="max-w-xl mx-auto p-8 rounded-2xl border border-amber-500/50 bg-amber-500/10 mb-10">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-muted-foreground text-sm sm:text-base mb-8 max-w-lg mx-auto">
                Join 10,000+ students who trust TechVyro for quality study materials. All PDFs are free and updated daily.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <a 
                  href="#content"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-all duration-300 hover:-translate-y-0.5 shadow-lg shadow-primary/25"
                >
                  Browse PDFs
                </a>
                <a 
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl border border-border bg-card text-foreground font-semibold hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
                >
