        ...
        <div className="container mx-auto px-3 sm:px-4">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="col-span-2 md:col-span-1 space-y-3 sm:space-y-4">
              <h3 className="text-base sm:text-lg font-bold text-foreground">TechVyro</h3>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex gap-2 sm:gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-lg bg-muted hover:bg-primary hover:text-primary-foreground transition-colors"
